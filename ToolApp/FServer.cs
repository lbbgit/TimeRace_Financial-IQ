...
namespace ToolApp
{
    public partial class FServer : Form
    {
        public FServer()
        {
            ...
            btnBeginListern.Click += btnServerConn_Click;

            btnSend.Click += btnSendMsg_Click;
        }
        ...
        private void btnServerConn_Click(object sender, EventArgs e)
        {
            ...
            txtSendMsg.AppendText("开始监听客户端传来的信息!" + "\r\n");
        ...
        private void ServerSendMsg(string sendMsg)
        {
            ...
            txtSendMsg.AppendText("So-flash:" + GetCurrentTime() + "\r\n" + sendMsg + "\r\n");
        }
        ...
        private void ServerRecMsg(object socketClientPara)
        {
            ...
            while (true)
            {
                ...
                //将发送的字符串信息附加到文本框txtMsg上  
                txtSendMsg.AppendText("接收到的消息:" + GetCurrentTime() + "\r\n" + strSRecMsg + "\r\n");
            }
        }
